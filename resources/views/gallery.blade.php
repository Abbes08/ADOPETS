        ...
        <div class="row">
            @foreach ($mascotas as $mascota)
                <div class="col-md-4 ftco-animate">
                    <div class="work mb-4 img d-flex align-items-end" style="background-image: url('{{ asset('storage/' . $mascota->fotos[0]) }}');">
                        <a href="{{ asset('storage/' . $mascota->fotos[0]) }}" class="icon image-popup d-flex justify-content-center align-items-center">
                            <span class="fa fa-expand"></span>
                        </a>
                        <div class="desc w-100 px-4">
                            <div class="text w-100 mb-3">
                                <span>{{ $mascota->tipo }}</span>
                                <h2><a href="{{ route('mascotas.show', $mascota->mascota_id) }}">{{ $mascota->nombre }}</a></h2>
                                <p class="mascota-tipo">{{ $mascota->es_venta ? 'Venta' : 'Adopción' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
